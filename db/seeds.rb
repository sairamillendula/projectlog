...
Province.create(:name => 'British Columbia', :short_name => 'BC')
Province.create(:name => 'Prince Edward Island', :short_name => 'PE')
Province.create(:name => 'Manitoba', :short_name => 'MB')
Province.create(:name => 'New Brunswick', :short_name => 'NB')
Province.create(:name => 'Nova Scotia', :short_name => 'NS')
...
Province.create(:name => 'Newfoundland and Labrador', :short_name => 'NL')
Province.create(:name => 'Northwest Territories', :short_name => 'NT')
...
puts "Creating plans..."
Plan.create(:name => "Free", :description => "Basic Plan free for everyone who sign up", :price => "0", frequency: 'Month', :active => true )
Plan.create(name: 'Premium', description: 'Paying Plan', price: '15', frequency: "Month", active: true, displayable: true, features: 
'YES Projects
YES Transactions
YES Invoices')
